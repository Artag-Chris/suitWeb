...
import { Play, RotateCcw, BarChart3, Code, Server, Database, Cloud } from "lucide-react"
...
const SaaSPage = () => {
  ...
  const optimizationSteps = [
    { name: "Análisis de Performance", status: "pending", risk: "medium", duration: "2-3 días" },
    { name: "Optimización de Assets", status: "pending", risk: "low", duration: "1-2 días" },
    { name: "Configuración de Cache", status: "pending", risk: "low", duration: "1 día" },
    { name: "Optimización de DB", status: "pending", risk: "high", duration: "3-4 días" },
    { name: "Implementación CDN", status: "pending", risk: "medium", duration: "1-2 días" },
  ]
                  ...
                  <div className=" p-4 border border-yellow-600/20">
                    ...
                    <div className="text-sm text-gray-300 space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>Base de datos y storage</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Server className="w-4 h-4 text-yellow-400" />
                        <span>CDN y distribución</span>
                      </div>
                      <div className="flex items-center gap-2">
      ...
      <section className=" py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm text-gray-300">
            {["Next.js", "React", "Node.js", "PostgreSQL", "MongoDB", "Vercel", "Firebase", "Stripe"].map((tech, i) => (
